...
# =====================
ALAVETELI_FQDN = ENV['ALAVETELI_VAGRANT_FQDN'] || "192.168.33.155"
ALAVETELI_IP = ENV['ALAVETELI_VAGRANT_IP'] || "192.168.33.155"
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Work around https://github.com/mysociety/alaveteli/issues/2392
